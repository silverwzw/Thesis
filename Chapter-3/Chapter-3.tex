...
\subsection{Deduplication}
    ...
    In a copy-on-write file system, new modifications to data blocks that are referenced by previous snapshots cannot be an in-place modification. In those cases, making a change to the file system means creation of new nodes. Creating a new block node is an expensive operation as it requires all data transferred to remote and storage space on remote.
