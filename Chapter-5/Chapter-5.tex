...
\section{File System Benchmark}
    ...
    The file system test results are shown in \tref{tab:fs_performance}. The result shows that although as a local file system the Kabi File System is not as good as Ext4, but as a dsitributed file system it is comparable to NFS.
